...
const (
	...
	// FieldPermissionValue holds the string denoting the permission_value field in the database.
	FieldPermissionValue = "permission_value"
...
var (
	...
	// PermissionValueValidator is a validator for the "permission_value" field. It is called by the builders before save.
	PermissionValueValidator func(string) error
)
...
// ByPermissionValue orders the results by the permission_value field.
func ByPermissionValue(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPermissionValue, opts...).ToFunc()
}
