...
func (pu *PermissionUpdate) SetPermissionValue(s string) *PermissionUpdate {
	pu.mutation.SetPermissionValue(s)
	return pu
}

// SetNillablePermissionValue sets the "permission_value" field if the given value is not nil.
func (pu *PermissionUpdate) SetNillablePermissionValue(s *string) *PermissionUpdate {
	if s != nil {
		pu.SetPermissionValue(*s)
	}
	return pu
}
...
func (pu *PermissionUpdate) check() error {
	if v, ok := pu.mutation.PermissionName(); ok {
		if err := permission.PermissionNameValidator(v); err != nil {
			return &ValidationError{Name: "permission_name", err: fmt.Errorf(`generated: validator failed for field "Permission.permission_name": %w`, err)}
		}
	}
	if v, ok := pu.mutation.PermissionValue(); ok {
		if err := permission.PermissionValueValidator(v); err != nil {
			return &ValidationError{Name: "permission_value", err: fmt.Errorf(`generated: validator failed for field "Permission.permission_value": %w`, err)}
		}
	}
	return nil
}
...
func (pu *PermissionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.PermissionValue(); ok {
		_spec.SetField(permission.FieldPermissionValue, field.TypeString, value)
	}
...
// SetPermissionValue sets the "permission_value" field.
func (puo *PermissionUpdateOne) SetPermissionValue(s string) *PermissionUpdateOne {
	puo.mutation.SetPermissionValue(s)
	return puo
}

// SetNillablePermissionValue sets the "permission_value" field if the given value is not nil.
func (puo *PermissionUpdateOne) SetNillablePermissionValue(s *string) *PermissionUpdateOne {
	if s != nil {
		puo.SetPermissionValue(*s)
	}
	return puo
}
...
func (puo *PermissionUpdateOne) check() error {
	...
	if v, ok := puo.mutation.PermissionValue(); ok {
		if err := permission.PermissionValueValidator(v); err != nil {
			return &ValidationError{Name: "permission_value", err: fmt.Errorf(`generated: validator failed for field "Permission.permission_value": %w`, err)}
		}
	}
...
func (puo *PermissionUpdateOne) sqlSave(ctx context.Context) (_node *Permission, err error) {
	...
	if value, ok := puo.mutation.PermissionValue(); ok {
		_spec.SetField(permission.FieldPermissionValue, field.TypeString, value)
	}
