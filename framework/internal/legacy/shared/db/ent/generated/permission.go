...
type Permission struct {
	...
	// Tên phân quyền, ví dụ: 'Product Read'
	PermissionName string `json:"permission_name,omitempty"`
	// Giá trị phân quyền, ví dụ: 'product_read'
	PermissionValue string `json:"permission_value,omitempty"`
...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case permission.FieldPermissionName, permission.FieldPermissionValue:
...
func (pe *Permission) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case permission.FieldPermissionValue:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field permission_value", values[i])
			} else if value.Valid {
				pe.PermissionValue = value.String
			}
		default:
...
func (pe *Permission) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("permission_value=")
	builder.WriteString(pe.PermissionValue)
	builder.WriteByte(')')
