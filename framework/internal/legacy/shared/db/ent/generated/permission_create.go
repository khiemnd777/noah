...
func (pc *PermissionCreate) SetPermissionValue(s string) *PermissionCreate {
	pc.mutation.SetPermissionValue(s)
	return pc
}
...
func (pc *PermissionCreate) check() error {
	if _, ok := pc.mutation.PermissionName(); !ok {
		return &ValidationError{Name: "permission_name", err: errors.New(`generated: missing required field "Permission.permission_name"`)}
	}
	...
	if _, ok := pc.mutation.PermissionValue(); !ok {
		return &ValidationError{Name: "permission_value", err: errors.New(`generated: missing required field "Permission.permission_value"`)}
	}
	if v, ok := pc.mutation.PermissionValue(); ok {
...
func (pc *PermissionCreate) createSpec() (*Permission, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.PermissionValue(); ok {
		_spec.SetField(permission.FieldPermissionValue, field.TypeString, value)
		_node.PermissionValue = value
	}
