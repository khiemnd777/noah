...
func GetProjectRootDir() string {
	return frameworkruntime.APIPath()
}
...
func GetModulePath(moduleName string, subpaths ...string) string {
	return frameworkruntime.APIModulePath(moduleName, subpaths...)
}

func GetAppConfigPath() string {
	return frameworkruntime.AppConfigPath()
}

func GetModuleConfigPath(moduleName string) string {
	return frameworkruntime.APIModuleConfigPath(moduleName)
}
