...
type AttributeFunc func(context.Context, *generated.AttributeMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AttributeFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AttributeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.AttributeMutation", m)
}

// The AttributeOptionFunc type is an adapter to allow the use of ordinary
// function as AttributeOption mutator.
type AttributeOptionFunc func(context.Context, *generated.AttributeOptionMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AttributeOptionFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AttributeOptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.AttributeOptionMutation", m)
}

// The AttributeOptionValueFunc type is an adapter to allow the use of ordinary
// function as AttributeOptionValue mutator.
type AttributeOptionValueFunc func(context.Context, *generated.AttributeOptionValueMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AttributeOptionValueFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AttributeOptionValueMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.AttributeOptionValueMutation", m)
}
...
// The DepartmentMemberFunc type is an adapter to allow the use of ordinary
// function as DepartmentMember mutator.
type DepartmentMemberFunc func(context.Context, *generated.DepartmentMemberMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f DepartmentMemberFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.DepartmentMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.DepartmentMemberMutation", m)
}

// The FolderFunc type is an adapter to allow the use of ordinary
// function as Folder mutator.
type FolderFunc func(context.Context, *generated.FolderMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f FolderFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.FolderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.FolderMutation", m)
}
...
type StaffFunc func(context.Context, *generated.StaffMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f StaffFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.StaffMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.StaffMutation", m)
}
